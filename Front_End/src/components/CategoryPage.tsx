						...
						<div className="col-lg-6">
							<div className="quick-view-content">
								<div className="top">
									...
									<div className="price d-flex align-items-center"><span className="lnr lnr-tag"></span> <span className="ml-10">$149.99</span></div>
								...
								<div className="middle">
									...
									<a href="#" className="view-full">View full Details <span className="lnr lnr-arrow-right"></span></a>
								</div>
								<div className="bottom">
									...
									<div className="quantity-container d-flex align-items-center mt-15">
										Quantity:
										<input type="text" className="quantity-amount ml-15" value="1" />
										<div className="arrow-btn d-inline-flex flex-column">
											<button className="increase arrow" type="button" title="Increase Quantity"><span className="lnr lnr-chevron-up"></span></button>
											<button className="decrease arrow" type="button" title="Decrease Quantity"><span className="lnr lnr-chevron-down"></span></button>
										</div>

									</div>
									<div className="d-flex mt-20">
										<a href="#" className="view-btn color-2"><span>Add to Cart</span></a>
										<a href="#" className="like-btn"><span className="lnr lnr-layers"></span></a>
										<a href="#" className="like-btn"><span className="lnr lnr-heart"></span></a>
									</div>
								</div>
							</div>
						</div>
