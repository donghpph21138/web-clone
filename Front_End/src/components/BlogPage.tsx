            ...
            <div className="row">
                <div className="col-lg-4">
                    <div className="categories_post">
                        <img src="src/assets/img/blog/cat-post/cat-post-3.jpg" alt="post"/>
                ...
                <div className="col-lg-4">
                    <div className="categories_post">
                        <img src="src/assets/img/blog/cat-post/cat-post-2.jpg" alt="post"/>
                        <div className="categories_details">
                            <div className="categories_text">
                                <a href="blog-details.html">
                                    <h5>Politics</h5>
                ...
                <div className="col-lg-4">
                    <div className="categories_post">
                        <img src="src/assets/img/blog/cat-post/cat-post-1.jpg" alt="post"/>
                        <div className="categories_details">
                            <div className="categories_text">
                                <a href="blog-details.html">
                                    <h5>Food</h5>
                ...
                <div className="col-lg-8">
                    <div className="blog_left_sidebar">
                        <article className="row blog_item">
                            ...
                            <div className="col-md-9">
                                <div className="blog_post">
                                    <img src="src/assets/img/blog/main-blog/m-blog-1.jpg" alt=""/>
                        ...
                        <article className="row blog_item">
                            ...
                            <div className="col-md-9">
                                <div className="blog_post">
                                    <img src="src/assets/img/blog/main-blog/m-blog-2.jpg" alt=""/>
                                    <div className="blog_details">
                                        <a href="single-blog.html">
                        ...
                        <article className="row blog_item">
                            ...
                            <div className="col-md-9">
                                <div className="blog_post">
                                    <img src="src/assets/img/blog/main-blog/m-blog-3.jpg" alt=""/>
                                    <div className="blog_details">
                                        <a href="single-blog.html">
                        ...
                        <article className="row blog_item">
                            ...
                            <div className="col-md-9">
                                <div className="blog_post">
                                    <img src="src/assets/img/blog/main-blog/m-blog-4.jpg" alt=""/>
                                    <div className="blog_details">
                                        <a href="single-blog.html">
                                            <h2>The Night Sky</h2>
                                        </a>
                        ...
                        <article className="row blog_item">
                            ...
                            <div className="col-md-9">
                                <div className="blog_post">
                                    <img src="src/assets/img/blog/main-blog/m-blog-5.jpg" alt=""/>
                                    <div className="blog_details">
                                        <a href="single-blog.html">
                ...
                <div className="col-lg-4">
                    <div className="blog_right_sidebar">
                        ...
                        <aside className="single_sidebar_widget author_widget">
                            <img className="author_img rounded-circle" src="src/assets/img/blog/author.png" alt=""/>
